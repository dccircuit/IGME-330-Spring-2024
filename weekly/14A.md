# Week 14A - Orientation to Park Buddy Starter & Firebase Notes

## 0. Exam 2 Notes
- Working on writing it
- [See notes so far](../notes/final-details.md)
---

## I. We completed the `localStorage` checkoff
- [Checkoff - `localStorage` Practice](https://github.com/tonethar/IGME-330-Master/blob/master/notes/localstorage-practice.md)
	- Was officially due Monday night.
---

## II. Taking a look at Park Buddy Starter
- [***Starter*** for HW-4 - *NY State Park Buddy*](../hw/hw-4-starter.md)
  - You might already be done, or you may need to complete, yet.  Officially due tomorrow night.
  - Sorry.  There's a lot of 'type in the code' for this starter assignment.  But it should get you ready to go.
---
...
- [***Starter*** for HW-4 - *NY State Park Buddy*](https://github.com/tonethar/IGME-330-Fall-2023/blob/main/hw/hw-4-starter.md)
  ...
  - ***don't miss this!***
- Don't delay, move right on to working on your [HW-4 - *NY State Park Buddy*](../hw/hw-4.md) homework.
  - due Monday night (with dropbox open through Reading Day for late submissions).
